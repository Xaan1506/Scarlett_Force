...
function App() {
  ...
  const filteredEvents = useMemo(() => {
    return mockEvents.filter(event => {
      ...
      // To satisfy a group, it must have AT LEAST ONE tag from the selected filters in that group
      // (OR logic within the same category, AND logic across different categories)
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex-1 max-w-md mx-8 hidden md:block">
              <input 
                ...
                className="w-full px-4 py-2 bg-slate-100 border-transparent focus:bg-white focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 rounded-full text-sm transition-all outline-none"
              />
            </div>
